...
class _ProfilWidgetState extends State<ProfilWidget>
  ...
  updateUserToFirebase(context) {
    ...
    if (_model.nomFamilleController.text != '' &&
      ...
      showCustomSnackBar(context, 'Merci de compléter votre profil',
          isError: true);
    }
  }
  ...
  getUserData() async {
    ...
    QuerySnapshot recherches = await FirebaseFirestore.instance
    ...
    if (docSnapshot.exists) {
      ...
      _model.countryValue = userData['country'] ?? '';
      ...
      _model.afficher_email = userData['afficher_email'] ?? true;
      _model.afficher_tel = userData['afficher_tel'] ?? true;

      final providerProfilUser =
          Provider.of<ProviderProfilUser>(context, listen: false);
      providerProfilUser.setSpecialisation(
          userData != null ? userData['specialisations'] : []);
      providerProfilUser.setLGO(userData != null ? userData['lgo'] : []);
      providerProfilUser
          .setCompetence(userData != null ? userData['competences'] : []);
      providerProfilUser
          .setLangues(userData != null ? userData['langues'] : []);
      providerProfilUser
                ...
                child: Wrap(
                  children: <Widget>[
                    ListTile(
                      ...
                      title: Text('Choisir une image depuis la gallerie',
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      'Séléctionnez si vous souhaitez être contacté par téléphone ou E-mail.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                              fontFamily: 'Poppins',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          value: _model.afficher_tel ??= false,
                                          onChanged: (newValue) async {
                                            setState(() =>
                                                _model.afficher_tel = newValue);
                                          },
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          value: _model.afficher_email ??=
                                              false,
                                          onChanged: (newValue) async {
                                            setState(() {
                                              _model.afficher_email = newValue;
                                            });
                                          },
                                          activeColor: Color(0xFF7CEDAC),
                                        ),
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onTap:
                                                                          (specialisation) =>
                                                                              {
                                                                        providerProfilUser
                                                                            .addSelectedSpecialisation(specialisation)
                                                                      },
                                                                    ),
                                                                  ),
                                                                );
