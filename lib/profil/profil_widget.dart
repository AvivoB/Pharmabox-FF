...
class _ProfilWidgetState extends State<ProfilWidget> with SingleTickerProviderStateMixin {
  ...
  updateUserToFirebase(context) {
    ...
    if (_model.nomFamilleController.text != '' && _model.prenomController.text != '' && _model.cityController.text != '' && _model.posteValue != null) {
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          ...
                                          onChanged: (newValue) async {
                                            setState(() => _model.afficher_tel = newValue);
                                          },
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch.adaptive(
                                          value: _model.afficher_email ??= false,
                                          onChanged: (newValue) async {
                                            setState(() {
