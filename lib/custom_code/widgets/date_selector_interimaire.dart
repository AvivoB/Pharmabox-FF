...
DateSelector({required this.onDatesChanged});
      ...
      children: [
        ...
        Row(
          ...
          children: weekdays.map((day) => Expanded(
            child: Center(child: Text(day, style: FlutterFlowTheme.of(context).bodySmall,))
          )).toList(),
        ),
       Expanded(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: selectedDates.contains(itemDate)
                ? greenColor
          ...
          child: Text(
            ...
            style: FlutterFlowTheme.of(context)
                              ...
                              .override(
                                  fontFamily: 'Poppins',
                                  color: isSelectable && selectedDates.contains(itemDate) ? Colors.white : Colors.grey.shade500,
                                  fontSize: 14.0,
