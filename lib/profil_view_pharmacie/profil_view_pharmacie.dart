                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_preparateurs'].toString() + ' Pharmacien${int.parse(pharmacieData['equipe']['nb_preparateurs']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_etudiants_6eme_annee'].toString() + ' Etudiant${int.parse(pharmacieData['equipe']['nb_etudiants_6eme_annee']) > 1 ? 's 6ème année' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
