                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_pharmaciens'].toString() + ' Pharmacien${int.parse(pharmacieData['equipe']['nb_pharmaciens']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_preparateurs'].toString() + ' Préparateur${int.parse(pharmacieData['equipe']['nb_preparateurs']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_rayonnistes'].toString() + ' Rayonniste${int.parse(pharmacieData['equipe']['nb_rayonnistes']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_conseillers'].toString() + ' Conseiller${int.parse(pharmacieData['equipe']['nb_conseillers']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_etudiants'].toString() + ' Etudiant${int.parse(pharmacieData['equipe']['nb_etudiants']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_etudiants_6eme_annee'].toString() + ' Etudiant${int.parse(pharmacieData['equipe']['nb_etudiants_6eme_annee']) > 1 ? 's ' : ''} en 6ème année', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
                                          ...
                                          Container(
                                            child: Row(
                                              children: [
                                                ...
                                                SizedBox(width: 10, height: 30),
                                                Text(pharmacieData['equipe']['nb_apprentis'].toString() + ' Apprenti${int.parse(pharmacieData['equipe']['nb_apprentis']) > 1 ? 's' : ''}', style: FlutterFlowTheme.of(context).headlineMedium.override(fontFamily: 'Poppins', color: FlutterFlowTheme.of(context).primaryText, fontSize: 16)),
                                              ],
                                            ),
                                          ),
                                        ]),
