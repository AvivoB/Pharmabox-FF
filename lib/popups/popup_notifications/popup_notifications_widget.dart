...
class PopupNotificationsWidget extends StatefulWidget {
  ...
  @override
  _PopupNotificationsWidgetState createState() => _PopupNotificationsWidgetState();
}
                    ...
                    child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (documents.isEmpty) {
                          return Center(
                            child: Text('Aucune notification', style: FlutterFlowTheme.of(context).bodyMedium.override(fontFamily: 'Poppins', color: blackColor, fontSize: 18.0, fontWeight: FontWeight.w600)),
                          );
                        }
                                        ...
                                        Container(
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            onPressed: () {
                                              ...
                                              FirebaseFirestore.instance.collection('notifications').doc(documents[index].id).delete();
                                            },
                                          ),
                                        ),
                                      ],
