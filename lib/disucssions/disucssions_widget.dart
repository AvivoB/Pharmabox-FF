...
class _DisucssionsWidgetState extends State<DisucssionsWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          elevation: 0.0,
          title: Text('Discussions', style: FlutterFlowTheme.of(context).bodyMedium.override(fontFamily: 'Poppins', color: blackColor, fontSize: 20.0, fontWeight: FontWeight.w600)),
          backgroundColor: Color.fromARGB(0, 255, 255, 255),
          leading: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Container(
              decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(30.0)), boxShadow: [
                BoxShadow(
                  blurRadius: 4.0,
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                          ...
                          builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
                            if (snapshot.hasError) {
                              return Text('Error: ${snapshot.error}'); // Handle the error accordingly
                            }
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => DiscussionUserWidget(toUser: otherUserId),
                                        ),
                                      );
                                    },
                                    child: Padding(
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  unreadMessagesCount > 0 && data['last_message_from'] != currentUser?.uid
                                                      ? Container(
                                                          decoration: BoxDecoration(
                                                            color: redColor,
                                                            shape: BoxShape.circle,
