...
class _PharmaJobWidgetState extends State<PharmaJobWidget> {
  ...
  void _getMesRecherches() async {
    ...
    setState(() {
      ...
      isTitulaire
          ? _findRecherche(mesRecherches[0])
                    ...
                    children: [
                      if (offres.isNotEmpty && isTitulaire == true)
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Mes dernières recherches enregistrées',
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          offres[selectedOffreSearchSaved]
                                                  ['poste'] ??
                                              '',
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Icon(Icons.work_outline),
                                      Text(
                                          recherches[selectedOffreSearchSaved][
                                              'poste'] /*   ?? '' + ' ' + recherches[0]['contrats'].toString() ?? '' + ' ' + recherches[0]['salaire_mensuel'] + ' €' ?? '', */,
                                          overflow: TextOverflow.ellipsis,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                    ...
                                    child: Container(
                                        width:
                                            MediaQuery.of(context).size.width *
                                                0.9,
                                        child:
                                            CardPharmacieOffreRechercheWidget(
                                                data: foundedOffres[i])),
                                  )
                              ],
                            ),
                          ),
