...
class _ProfilPharmacieState extends State<ProfilPharmacie>
  ...
  getUserData() async {
    ...
    QuerySnapshot offres = await FirebaseFirestore.instance
        ...
        .where('user_id', isEqualTo: user.uid)
        .get();
    DocumentSnapshot utilisateurTitu = await FirebaseFirestore.instance
        .collection('users')
        .doc(user.uid)
        .get();
    ...
    _model.nomdelapharmacieController1.text =
        userData != null ? userData['situation_geographique']['adresse'] : '';

    _model.nomdelapharmacieController2.text = userData != null
        ? userData['titulaire_principal']
        : userTituData['nom'] + ' ' + userTituData['prenom'];
    _model.presentationController.text =
        userData != null ? userData['presentation'] : '';
    _model.emailPharmacieController.text = userData != null
        ? userData['contact_pharma']['email']
        : userTituData['email'];
    ...
    _model.preferenceContactValue = userData != null
        ? userData['contact_pharma']['preference_contact']
        : '';
    _model.patientParJourValue =
        userData != null ? userData['nb_patient_jour'] : '';
    setState(() {
      _isLoading = false;
    });
  }
    ...
    pharmaciesRef
        ...
        .set({
          ...
          'situation_geographique': {
            ...
            'lat_lng': [
              providerPharmacieUser.selectedAdressePharma[0]['latitude'],
              providerPharmacieUser.selectedAdressePharma[0]['longitude']
            ],
        ...
        .catchError((error) => showCustomSnackBar(
            context, 'Erreur d\'enregistrement',
            isError: true));
  }
  ...
  Widget build(BuildContext context) {
    ...
    providerPharmacieUser
        .setConfort(userData != null ? userData['confort'] : []);
    providerPharmacieUser
        .setHoraire(userData != null ? userData['horaires'] : null);
                ...
                child: Column(
                  ...
                  children: [
                    CarouselPharmacieSliderSelect(
                      ...
                      initialImagesSelected:
                          userData != null && userData['photo_url'] != ''
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'Séléctionnez si vous souhaitez être contacté via les infos de contact de la pharmacie ou de votre profil.',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                                fontFamily: 'Poppins',
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Switch.adaptive(
                                            value: _model.typologie ==
                                                    'Centre commercial'
                                                ? true
                                                : false,
                                            onChanged: (newValue) async {
                                              setState(() => _model.typologie =
                                                  'Centre commercial');
                                            },
                                            activeColor: Color(0xFF7CEDAC),
                                          ),
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Switch.adaptive(
                                            value: _model.typologie == 'Gare'
                                                ? true
                                                : false,
                                            onChanged: (newValue) async {
                                              setState(() =>
                                                  _model.typologie = 'Gare');
                                            },
                                            activeColor: Color(0xFF7CEDAC),
                                          ),
                                        ],
