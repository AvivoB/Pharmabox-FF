...
class _ProfilPharmacieState extends State<ProfilPharmacie>
  ...
  Widget build(BuildContext context) {
    ...
    _model.phonePharmacieController1.text =
        userData['contact_pharma']['telephone'] ?? '';
    _model.rerController.text = userData['accessibilite']['rer'] ?? '';
    _model.metroController.text = userData['accessibilite']['metro'] ?? '';
    _model.busController.text = userData['accessibilite']['bus'] ?? '';
    _model.tramwayController1.text = userData['accessibilite']['tram'] ?? '';
    _model.tramwayController2.text = userData['accessibilite']['gare'] ?? '';
    _model.nbPharmaciensController.text =
        userData['equipe']['nb_pharmaciens'] ?? '';
    _model.nbPreparateurController.text =
        userData['equipe']['nb_preparateurs'] ?? '';
    _model.nbRayonnistesController.text =
        userData['equipe']['nb_rayonnistes'] ?? '';
    _model.nbConseillersController.text =
        userData['equipe']['nb_conseillers'] ?? '';
    _model.nbApprentiController.text = userData['equipe']['nb_apprentis'] ?? '';
    _model.nbEtudiantsController.text =
        userData['equipe']['nb_etudiants'] ?? '';
    _model.nbEtudiants6emeController.text =
        userData['equipe']['nb_etudiants_6eme_annee'] ?? '';
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    MapAdressePharmacie(
                                        onInitialValue:
                                            userData['situation_geographique']['data']
                                                    ['rue'] +
                                                ', ' +
                                                userData['situation_geographique']
                                                    ['data']['ville'] +
                                        ...
                                        onAdressSelected: (latitude,
                                          ...
                                          _model.pharmacieAdresseController.text =
                                              adresse;
                                          providerPharmacieUser.setAdresse(postcode,
                                          ...
                                          Container(
                                              ...
                                              child: SliderSimple(
                                                slider: userData['tendances'][0]
                                                    ...
                                                    1,
                                                onChanged: (value) {
                                                  providerPharmacieUser.setTendences(
                                                      1, 'Cosmétiques', value);
                                                },
                                              )),
                                        ],
